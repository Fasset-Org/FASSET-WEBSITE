        ...
        >
          ...
          <Stack width="70%">
            <Typography>
              ...
              on the approval of sector grants and stakeholder needs according
              to FASSET regulations, processes, and procedures.
            </Typography>
          </Stack>
        </Stack>
        ...
        <Stack width="100%">
          <Accordion>
            <AccordionSummary
              ...
              sx={{ backgroundColor: "primary.main" }}
            >
              <Typography fontSize={15}>Knowledge & Skills Required</Typography>
            </AccordionSummary>
            <AccordionDetails>
              <List
                sx={{

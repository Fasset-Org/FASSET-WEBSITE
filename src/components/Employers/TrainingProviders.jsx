    ...
    <Stack spacing={2}>
      ...
      <Typography textAlign="justify">
        <ul>
          ...
          <Typography>
            ...
            for online registration of assessors and moderators can be accessed
            here.
          </Typography>
        </ul>
      </Typography>
      ...
      <Typography textAlign="justify">
        <ul>
          ...
          <li>
            Experience and expertise associated with assessment of education and
            training is deemed an advantage
          </li>
        </ul>
      </Typography>
      <Typography>Fasset PQA Team</Typography>
      ...
      <Typography textAlign="justify">
        <ul>
          <li> Be registered with Fasset as an assessor</li>
          <li>
            Have been deemed competent and certified for the generic Moderator
            Unit Standard (Unit Standard 115759 – Conduct moderation of
            outcomes-based assessment) by an ETDP SETA accredited provider.
          </li>
          <li>
            New applications for assessors and moderators affiliated with new
            training provider accreditation applications.
          ...
          <li>
            Have experience in outcomes-based assessment Fasset reserves the
            right to request additional information from an applicant during the
            evaluation.
          </li>
        </ul>
      </Typography>
      ...
      <Typography textAlign="justify">
        <ul>
          ...
          <li>Attach all relevant and supporting documentation</li>
          <li>
      ...
      <Typography textAlign="justify">
        <ul>
          <li> Statement of Results issued by ETDP SETA</li>
      ...
      <Typography textAlign="justify">
        <ul>
          ...
          <li>Fasset’s Chief Executive Officer</li>
          <li>Quality Council for Trades and Occupations</li>
          <li>South African Qualifications Authority</li>
          <li>Department of Higher Education and Training</li>
          <li>Any relevant QAB’s</li>
        </ul>
      </Typography>
      <Typography
        fontSize={20}
      ...
      <Typography textAlign="justify">
        <ul>
          ...
          <li>Assessment and moderation quality management system</li>
          <li>Assessment process, methodology and instruments</li>
          <li>
            Internal moderation process, methodology, instruments and reports
          </li>
          <li>Completed assessments (sample)</li>
          <li>Assessment decisions</li>
          <Typography>
            The majority of qualifications within Fasset’s scope of quality
            assurance responsibility are subject to summative assessment
            performed by the relevant professional body. Verification of
            assessment for other qualifications, skills programmes and unit
            standards is conducted on site at the accredited provider.
            Verification is normally performed once per annum, depending on
            performance.
          </Typography>
          <br />
          <Typography>
            Fasset issues certificates for the achievement of qualifications and
            learnerships, and a statement of results for skills programmes and
            unit standards. Certificates and statements of results can only be
            issued if verification was successful and learner data has been
            reported in the format prescribed by Fasset.
          </Typography>
          <br />
          <Typography>

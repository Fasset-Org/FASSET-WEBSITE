...
const EISA = () => {
  return (
    <Stack spacing={2}>
      ...
      <Typography textAlign="justify">
        EISA’s are conducted through accredited Assessment Centres. Registration
        for EISA can be requested by the SDP or by the individual leaner. FASSET
        will publish a calendar or dates for the scheduling of EISAs for all the
        occupational qualifications with learners in the system.
      </Typography>
    </Stack>
  );
};
